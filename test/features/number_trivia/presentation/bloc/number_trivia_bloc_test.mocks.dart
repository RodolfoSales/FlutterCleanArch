...
// in flutter_tostudy/test/features/number_trivia/presentation/bloc/number_trivia_bloc_test.dart.
...
import 'package:flutter_tostudy/core/error/failures.dart' as _i6;
import 'package:flutter_tostudy/core/usecases/usecase.dart' as _i8;
import 'package:flutter_tostudy/core/util/input_converter.dart' as _i10;
...
class MockInputConverter extends _i1.Mock implements _i10.InputConverter {
  @override
  _i3.Either<_i6.Failure, int> stringToUsignedInteger(String? str) =>
      (super.noSuchMethod(
        Invocation.method(
          #stringToUsignedInteger,
          [str],
        ),
